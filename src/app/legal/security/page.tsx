        ...
        <div className='relative z-10 max-w-[1400px] mx-auto px-6 md:px-12'>
          ...
          <FadeIn delay={0.1}>
            <h1 className='text-4xl md:text-5xl lg:text-[64px] font-extrabold text-white tracking-[-0.03em] leading-[0.95] mb-4'>
              Security Policy<span className='text-[#8B9DAF]'>.</span>
            </h1>
          </FadeIn>
            ...
            <div className='card p-8 md:p-12'>
              <div className='prose prose-invert max-w-none'>
                <p className='text-[14px] text-[#999999] leading-[1.8] mb-4'>
                  This Security Policy governs your use of SecQA. By accessing or using the Service, you agree to the terms outlined below. If you do not agree, you may not access or use the Service.
                </p>
                <p className='text-[14px] text-[#999999] leading-[1.8] mb-4'>
                ...
                <p className='text-[14px] text-[#999999] leading-[1.8] mb-4'>
                  For questions about this Security Policy, contact us at founder@secqa.example. We respond within 24 hours during business days.
                </p>
