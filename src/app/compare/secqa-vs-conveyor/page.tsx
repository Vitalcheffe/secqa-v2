...
export const metadata = {
  title: 'SecQA vs Conveyor — Comparison',
  description: 'Detailed comparison: SecQA vs Conveyor.'
};
  ...
  return (
    <div style={{ background: '#EEEEEE', color: '#222831', fontFamily: 'Inter, sans-serif' }}>
      ...
      <section style={{ background: '#222831', color: '#EEEEEE', padding: '4rem 2rem', textAlign: 'center' }}>
        <h1 style={{ fontSize: 'clamp(2.2rem, 5vw, 3.5rem)', fontWeight: 800, letterSpacing: '-0.02em', margin: '0 0 1rem' }}>SecQA vs <span style={{ color: '#00ADB5' }}>Conveyor</span></h1>
      ...
      <section style={{ padding: '3rem 2rem', maxWidth: '900px', margin: '0 auto' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
          ...
          <div style={{ background: '#393E46', color: '#EEEEEE', borderRadius: '12px', padding: '2rem' }}>
            <h3 style={{ fontWeight: 700, fontSize: '1.2rem', margin: '0 0 0.5rem' }}>Conveyor</h3>
            <div style={{ fontSize: '2rem', fontWeight: 800, margin: '0.5rem 0' }}>$12,000/year</div>
            <p style={{ fontSize: '0.85rem', color: 'rgba(238,238,238,0.7)' }}>Enterprise security questionnaire automation</p>
          </div>
        </div>
      </section>
      <section style={{ background: '#222831', color: '#EEEEEE', padding: '3rem 2rem' }}>
        <div style={{ maxWidth: '900px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
          ...
          <div>
            <h3 style={{ fontWeight: 700, marginBottom: '1rem', color: 'rgba(238,238,238,0.6)' }}>Where Conveyor wins</h3>
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '0.6rem' }}>
      ...
      <section style={{ padding: '3rem 2rem', maxWidth: '760px', margin: '0 auto' }}>
        ...
        <p style={{ fontSize: '0.9rem', color: 'rgba(34,40,49,0.7)', lineHeight: 1.6 }}>Choose Conveyor if you are $50M+ ARR with dedicated security team. Choose SecQA if you are $1M-$20M ARR and need questionnaire response workflow at a price that makes sense.</p>
      </section>
