          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            ...
            <FadeIn direction='left' delay={0.1}>
              <div className='card p-8'>
                <h3 className='text-lg font-bold text-white mb-2'>Drata</h3>
                <div className='flex items-baseline gap-1 mb-2'>
                  <span className='text-4xl font-extrabold text-white'>$10,000+/year</span>
                </div>
                <p className='text-[13px] text-[#666666]'>Continuous compliance monitoring</p>
              </div>
            </FadeIn>
          </div>
        </div>
      ...
      <section className='py-12 md:py-20 bg-[#111111]'>
        <div className='max-w-[1000px] mx-auto px-6 md:px-12'>
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
            ...
            <FadeIn direction='left' delay={0.1}>
              <div>
                <h3 className='text-[16px] font-bold text-white/60 mb-4'>Where Drata wins</h3>
                <ul className='space-y-3'>
        ...
        <div className='max-w-[800px] mx-auto px-6 md:px-12'>
          <FadeIn>
            ...
            <p className='text-[14px] text-[#999999] leading-[1.7]'>
              Choose Drata if you are $50M+ ARR with dedicated security team and budget for enterprise tools.
