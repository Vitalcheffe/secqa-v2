  ...
  return (
    <div style={{ background: '#EEEEEE', color: '#222831', fontFamily: 'Inter, sans-serif' }}>
      ...
      <section style={{ background: '#222831', color: '#EEEEEE', padding: '5rem 2rem', textAlign: 'center' }}>
        ...
        <p style={{ fontSize: '1.1rem', color: 'rgba(238,238,238,0.7)', maxWidth: '600px', margin: '0 auto 2rem', lineHeight: 1.6 }}>Send metrics to Datadog.</p>
      ...
      <section style={{ padding: '4rem 2rem', maxWidth: '760px', margin: '0 auto' }}>
        ...
        <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '0.8rem' }}>
          <li style={{ display: 'flex', gap: '0.5rem', fontSize: '0.9rem', color: 'rgba(238,238,238,0.8)' }}><span style={{ color: '#00ADB5' }}>&#10003;</span><span>Custom metrics</span></li>
          <li style={{ display: 'flex', gap: '0.5rem', fontSize: '0.9rem', color: 'rgba(238,238,238,0.8)' }}><span style={{ color: '#00ADB5' }}>&#10003;</span><span>Dashboards</span></li>
          <li style={{ display: 'flex', gap: '0.5rem', fontSize: '0.9rem', color: 'rgba(238,238,238,0.8)' }}><span style={{ color: '#00ADB5' }}>&#10003;</span><span>Alerts</span></li>
      ...
      <section style={{ background: '#222831', color: '#EEEEEE', padding: '4rem 2rem' }}>
        <div style={{ maxWidth: '760px', margin: '0 auto' }}>
          ...
          <li style={{ display: 'flex', gap: '0.8rem', alignItems: 'start' }}><span style={{ width: '24px', height: '24px', borderRadius: '50%', background: 'rgba(0,173,181,0.2)', color: '#00ADB5', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.75rem', fontWeight: 700, flexShrink: 0 }}>2</span><span style={{ fontSize: '0.9rem', color: 'rgba(238,238,238,0.8)', paddingTop: '0.2rem' }}>Add to SecQA</span></li>
          <li style={{ display: 'flex', gap: '0.8rem', alignItems: 'start' }}><span style={{ width: '24px', height: '24px', borderRadius: '50%', background: 'rgba(0,173,181,0.2)', color: '#00ADB5', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.75rem', fontWeight: 700, flexShrink: 0 }}>3</span><span style={{ fontSize: '0.9rem', color: 'rgba(238,238,238,0.8)', paddingTop: '0.2rem' }}>Select metrics</span></li>
          </ol>
        </div>
      </section>
